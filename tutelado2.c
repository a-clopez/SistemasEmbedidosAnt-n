...
//Calibración na que se pide rotar a placa para evitar valores anómalos q daba antes
...
int main(void)
{
    ...
    //Debug para revisar que esté correcto o address to acelerómetro e magnetómetro
    ...
    while (1)
    {
        if (BOARD_Accel_I2C_Receive(MAG3110_ADDR, MAG3110_DR_STATUS, 1, readBuff, 7) == kStatus_Success)
        {
            ...
            //Print de valores de rotación e leds para debug
